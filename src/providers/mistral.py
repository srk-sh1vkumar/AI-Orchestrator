"""Mistral LLM provider integration (Ollama)."""
...
class MistralProvider(BaseLLMProvider):
    """Mistral LLM provider for general incident analysis."""

    def __init__(self) -> None:
        """Initialize Mistral provider."""
        super().__init__(LLMProvider.MISTRAL)
    ...
    async def complete(
        ...
        try:
            ...
            formatted_messages.insert(
                ...
                {
                    "role": "system",
                    "content": """You are Mistral, a specialized AI for comprehensive incident analysis:
                    - Analyze system failures and incidents
                    - Identify root causes across multiple systems
                    - Correlate events and anomalies
    ...
    async def health_check(self) -> bool:
        """Check if Mistral is accessible.
